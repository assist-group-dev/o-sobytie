      ...
      <div className="p-8">
        ...
        <div className="prose prose-sm max-w-none text-[var(--foreground)]/80 space-y-6">
          <div>
            ...
            <p>
              Доставка коробок О!СОБЫТИЕ осуществляется курьерской службой по всей России. 
              Срок доставки составляет 5-7 рабочих дней с момента отправки.
            </p>
            <p className="mt-2">
              В крупных городах доступна экспресс-доставка (1-2 дня) за дополнительную плату.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>
              Доставка по России включена в стоимость подписки. При единоразовом заказе 
              стоимость доставки составляет 500 рублей.
            </p>
          </div>
        </div>
      </div>
